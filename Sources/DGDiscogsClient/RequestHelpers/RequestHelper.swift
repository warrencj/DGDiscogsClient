...
class RequestHelper {
        ...
        completion : @escaping completionHandler)
    {
        ...
        Session.default.request(url, method: method, parameters: parameters, encoding: encoding, headers: headers).responseJSON { response in
    ...
    func responseError(_ response: DataResponse<Any, Error>) {
